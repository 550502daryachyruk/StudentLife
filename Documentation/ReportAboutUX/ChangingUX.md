...
Также мы видим смысл в добавлении красок.
...
### Улучшения
Улучения проведены в цыетовых решениях в магазине (купленные товары имеют статус "куплено "зеленым цветом, некупленные - красным "Еще не куплено"). Также к фиолетовому фону подобран
желтый цвет кнопок. И изменена иконка приложения. Другие такого же рода изменения вы можете видеть на картинках.
